...
MAX_PAUSE_WITHIN_SEGMENT = 2.0  # Maximum pause within a segment (in seconds)
...
def simple_speaker_diarization(word_segments, max_pause=2.0):
    """
    Simple speaker diarization based on pauses and question-answer patterns.
    """
    ...
    for i in range(1, len(word_segments)):
        ...
        # Switch speaker if pause is significant, or if a question is detected followed by a response
        if pause > max_pause or (is_question and is_short_pause):
